...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://marcinmg.github.io/";
    ...
    public String createCrudAppTestTaks() throws InterruptedException {
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("mmgrabowski@o2.pl");
    ...
    public void shouldCreateTrelloCard() throws InterruptedException {
        String taskName = createCrudAppTestTaks();
